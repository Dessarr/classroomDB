...
<head>
    ...
    <title>Admin Dashboard - Classroom</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <span class="nav-link text-white">Welcome, Admin <?php echo $_SESSION['username']; ?></span>
                    </li>
                    <li class="nav-item">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-info"
                                                onclick="viewUser(<?php echo $teacher['id']; ?>, 'teacher')">
                                                <i class="bi bi-eye"></i>
                                            </button>
                                            <button class="btn btn-sm btn-warning"
                                                onclick="editUser(<?php echo $teacher['id']; ?>, 'teacher')">
                                                <i class="bi bi-pencil"></i>
                                            </button>
                                            <button class="btn btn-sm btn-danger"
                                                onclick="deleteUser(<?php echo $teacher['id']; ?>, 'teacher')">
                            ...
                            <table class="table table-striped table-hover" id="studentsTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-info"
                                                onclick="viewUser(<?php echo $student['id']; ?>, 'student')">
                                                <i class="bi bi-eye"></i>
                                            </button>
                                            <button class="btn btn-sm btn-warning"
                                                onclick="editUser(<?php echo $student['id']; ?>, 'student')">
                                                <i class="bi bi-pencil"></i>
                                            </button>
                                            <button class="btn btn-sm btn-danger"
                                                onclick="deleteUser(<?php echo $student['id']; ?>, 'student')">
                                                <i class="bi bi-trash"></i>
                                            </button>
                                        </td>
                                    </tr>
